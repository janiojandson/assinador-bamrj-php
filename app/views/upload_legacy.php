...
<div style="max-width: 800px; margin: 40px auto; background: white; padding: 30px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); border-top: 5px solid #f39c12;">
    ...
    <form action="/upload_legado" method="POST" enctype="multipart/form-data">
        ...
        <div style="background: #e9ecef; padding: 12px; border-radius: 5px; border-left: 4px solid #6c757d; margin-bottom: 20px;">
            <strong>Protocolo Gerado:</strong> <code style="font-size: 1.1em; color: #d32f2f;">BAMRJ-LEGADO-[ANO]-Automático</code>
        </div>
        ...
        <div style="display: flex; gap: 10px;">
            ...
            <a href="/index" style="background: #6c757d; color: white; text-align: center; text-decoration: none; padding: 12px 20px; flex: 1; border-radius: 4px; font-weight: bold; font-size: 1.05em; display: inline-block; box-sizing: border-box;">Cancelar</a>
        </div>
    </form>
</div>
